python policy_gradient.py --seed 20  --name "full_algorithm" --eval_trials 20 --eval_frq 5 --batch_size 10 --epochs 100  --exp_dir "experiments/initial_tests" --shaped_reward --counterfactual --object_prior
